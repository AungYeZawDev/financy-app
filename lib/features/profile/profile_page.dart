...
class _ProfilePageState extends State<ProfilePage>
  ...
  void _handleProfileStateChange() {
    ...
    switch (state.runtimeType) {
      ...
      case const (ProfileStateSuccess):
  ...
  void _handleSyncStateChange() async {
    switch (_syncController.state.runtimeType) {
      case DownloadingDataFromServer _:
        showDialog(
        ...
        break;
      case const (DownloadedDataFromServer):
        _syncController.syncToServer();
        break;
      case const (UploadedDataToServer):
        ...
        break;
      case const (SyncStateError):
      case const (UploadDataToServerError):
      case const (DownloadDataFromServerError):
        Navigator.pop(context);
        showCustomModalBottomSheet(
          context: context,
